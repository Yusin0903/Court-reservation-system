<?php  
	...
	$sql = "SELECT * FROM baseball WHERE date = '06-21'";
	...
	$sql1 = "SELECT * FROM baseball WHERE date = '06-22'";
	...
	$sql2 = "SELECT * FROM baseball WHERE date = '06-23'";
	$result2 = mysqli_query($link,$sql2);

	$row2 = mysqli_fetch_array($result2,MYSQLI_NUM); //將陣列以欄位名索引


	$sql3 = "SELECT * FROM baseball WHERE date = '06-24'";
	...
	$sql4 = "SELECT * FROM baseball WHERE date = '06-25'";
	$result4 = mysqli_query($link,$sql4);

	$row4 = mysqli_fetch_array($result4,MYSQLI_NUM); //將陣列以欄位名索引

	$sql5 = "SELECT * FROM baseball WHERE date = '06-26'";
	$result5 = mysqli_query($link,$sql5);

	$row5 = mysqli_fetch_array($result5,MYSQLI_NUM); //將陣列以欄位名索引

	$sql6 = "SELECT * FROM baseball WHERE date = '06-27'";
			...
			<tr>
				...
				<form action="new_reserve.php" method="post">	
					<td bgcolor= "<?php echo $row[1]; ?>">
						...
						<input type = "hidden" name = 'court' value = "baseball">
					</td>
				</form >
				<form action="new_reserve.php" method="post">		
